...
A Git\+Hub Action that sets up a Fortran development environment using Conda. Inspired by \href{https://degenerateconic.com/conda-plus-fortran.html}{\texttt{ Conda + Fortran}}.\hypertarget{md_README_autotoc_md6}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md6}
\hypertarget{md_README_autotoc_md7}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md7}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md13}{}\doxysection{\texorpdfstring{✅ Status}{✅ Status}}\label{md_README_autotoc_md13}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md14}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md14}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md15}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md15}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md16}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md16}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md17}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md17}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md18}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md18}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output, then in {\ttfamily -\/-\/local} mode to update files and tags locally, and finally without any flags to push changes and publish the Git\+Hub release.\hypertarget{md_README_autotoc_md19}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md19}
