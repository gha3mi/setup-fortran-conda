...
\end{longtabu}
\hypertarget{md_README_autotoc_md51}{}\doxysubsection{\texorpdfstring{mac\+OS}{mac\+OS}}\label{md_README_autotoc_md51}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
lfortran   &clang   &clang++   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_README_autotoc_md52}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md52}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md53}{}\doxysection{\texorpdfstring{Simple Usage}{Simple Usage}}\label{md_README_autotoc_md53}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md54}{}\doxysection{\texorpdfstring{✅ CI Status}{✅ CI Status}}\label{md_README_autotoc_md54}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md55}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md55}
\hypertarget{md_README_autotoc_md56}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md56}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md57}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md57}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md58}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md58}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md59}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md59}
\tabulinesep=1mm
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md60}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md60}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md61}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md61}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md62}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md62}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md63}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md63}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md64}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md64}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md65}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md65}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md66}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md66}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output.\hypertarget{md_README_autotoc_md67}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md67}
