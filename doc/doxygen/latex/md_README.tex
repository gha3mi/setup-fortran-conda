...
\end{longtabu}
\hypertarget{md_README_autotoc_md13}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md13}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md14}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md14}
\hypertarget{md_README_autotoc_md15}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md15}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md16}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md16}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md17}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md17}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md18}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md18}
\tabulinesep=1mm
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md19}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md19}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md20}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md21}{}\doxysection{\texorpdfstring{✅ Status}{✅ Status}}\label{md_README_autotoc_md21}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md22}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md22}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md23}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md23}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md24}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md24}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md25}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md25}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md26}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md26}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output, then in {\ttfamily -\/-\/local} mode to update files and tags locally, and finally without any flags to push changes and publish the Git\+Hub release.\hypertarget{md_README_autotoc_md27}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md27}
