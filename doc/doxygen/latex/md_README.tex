...
The selected Fortran compiler is installed along with the corresponding C and C++ compilers, as well as {\ttfamily fpm}, {\ttfamily cmake} and {\ttfamily ninja}. Additional packages can be installed using the {\ttfamily extra-\/packages} input.\hypertarget{md_README_autotoc_md22}{}\doxysubsection{\texorpdfstring{Ubuntu}{Ubuntu}}\label{md_README_autotoc_md22}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md25}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md25}
\hypertarget{md_README_autotoc_md26}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md26}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md27}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md27}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md28}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md28}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md29}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md29}
\tabulinesep=1mm
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md30}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md30}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md31}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md32}{}\doxysection{\texorpdfstring{✅ Status}{✅ Status}}\label{md_README_autotoc_md32}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md33}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md33}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md34}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md34}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md35}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md35}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md36}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md36}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md37}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md37}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output, then in {\ttfamily -\/-\/local} mode to update files and tags locally, and finally without any flags to push changes and publish the Git\+Hub release.\hypertarget{md_README_autotoc_md38}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md38}
