...
async function setup(version = '') {
  await (0,_common_js__WEBPACK_IMPORTED_MODULE_1__/* .setupCondaCompiler */ .SE)({
    version,
    versionedPackages: [
      'ifx_win-64',
      'intel-fortran-rt',
    ...
    channels: [_common_js__WEBPACK_IMPORTED_MODULE_1__/* .INTEL_CONDA_CHANNEL */ .dV, _common_js__WEBPACK_IMPORTED_MODULE_1__/* .CONDA_FORGE_CHANNEL */ .Av],
