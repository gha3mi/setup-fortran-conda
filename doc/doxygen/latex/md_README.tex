...
\end{longtabu}
\hypertarget{md_README_autotoc_md34}{}\doxysubsection{\texorpdfstring{mac\+OS}{mac\+OS}}\label{md_README_autotoc_md34}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
lfortran   &clang   &clang++   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_README_autotoc_md35}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md35}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md36}{}\doxysection{\texorpdfstring{Simple Usage}{Simple Usage}}\label{md_README_autotoc_md36}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md37}{}\doxysection{\texorpdfstring{✅ CI Status}{✅ CI Status}}\label{md_README_autotoc_md37}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md38}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md38}
\hypertarget{md_README_autotoc_md39}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md39}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md40}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md40}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md41}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md41}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md42}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md42}
\tabulinesep=1mm
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md43}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md43}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md44}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md44}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md45}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md45}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md46}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md46}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md47}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md47}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md48}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md48}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md49}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md49}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output.\hypertarget{md_README_autotoc_md50}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md50}
