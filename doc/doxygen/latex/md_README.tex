...
\end{longtabu}
\hypertarget{md_README_autotoc_md76}{}\doxysubsection{\texorpdfstring{mac\+OS}{mac\+OS}}\label{md_README_autotoc_md76}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
lfortran   &clang   &clang++   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_README_autotoc_md77}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md77}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md78}{}\doxysection{\texorpdfstring{Simple Usage}{Simple Usage}}\label{md_README_autotoc_md78}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ -\/\ \{os:\ macos-\/latest,\ \ \ compiler:\ flang-\/new\}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ -\/\ \{os:\ macos-\/latest,\ \ \ compiler:\ ifx\}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ -\/\ \{os:\ macos-\/latest,\ \ \ compiler:\ nvfortran\}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ -\/\ \{os:\ windows-\/latest,\ compiler:\ nvfortran\}}
\DoxyCodeLine{\ \ \ \ steps:}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md79}{}\doxysection{\texorpdfstring{✅ CI Status}{✅ CI Status}}\label{md_README_autotoc_md79}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md80}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md80}
\hypertarget{md_README_autotoc_md81}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md81}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md82}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md82}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md83}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md83}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md84}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md84}
\tabulinesep=1mm
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md85}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md85}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md86}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md86}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md87}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md87}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md88}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md88}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md89}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md89}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md90}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md90}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md91}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md91}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output.\hypertarget{md_README_autotoc_md92}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md92}
