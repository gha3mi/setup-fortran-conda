...
A Git\+Hub Action that sets up a Fortran development environment using Conda. Inspired by \href{https://degenerateconic.com/conda-plus-fortran.html}{\texttt{ Conda + Fortran}}.\hypertarget{md_README_autotoc_md2}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md2}
\hypertarget{md_README_autotoc_md3}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md3}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md4}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md4}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md5}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md5}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md6}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md6}
\tabulinesep=1mm
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md7}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md7}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md8}{}\doxysection{\texorpdfstring{✅ Status}{✅ Status}}\label{md_README_autotoc_md8}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md9}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md9}
