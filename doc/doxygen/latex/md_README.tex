...
\label{md_README_autotoc_md37}%
\Hypertarget{md_README_autotoc_md37}%


A Git\+Hub Action that sets up a Fortran development environment using Conda. Inspired by \href{https://degenerateconic.com/conda-plus-fortran.html}{\texttt{ Conda + Fortran}}.\hypertarget{md_README_autotoc_md38}{}\doxysection{\texorpdfstring{Supported Compiler Configurations}{Supported Compiler Configurations}}\label{md_README_autotoc_md38}
The selected Fortran compiler is installed along with the corresponding C and C++ compilers, as well as {\ttfamily fpm}, {\ttfamily cmake}, {\ttfamily ninja} and {\ttfamily meson}. Additional packages can be installed using the {\ttfamily extra-\/packages} input.\hypertarget{md_README_autotoc_md39}{}\doxysubsection{\texorpdfstring{Ubuntu}{Ubuntu}}\label{md_README_autotoc_md39}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_README_autotoc_md40}{}\doxysubsection{\texorpdfstring{mac\+OS}{mac\+OS}}\label{md_README_autotoc_md40}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
lfortran   &clang   &clang++   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_README_autotoc_md41}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md41}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md42}{}\doxysection{\texorpdfstring{Simple Usage}{Simple Usage}}\label{md_README_autotoc_md42}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md43}{}\doxysection{\texorpdfstring{✅ CI Status}{✅ CI Status}}\label{md_README_autotoc_md43}
\tabulinesep=1mm
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ macos   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ ubuntu   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ windows    }\\\cline{1-4}
\endhead
{\ttfamily flang-\/new}   &-\/   &cmake ✅   &fpm ❌ cmake ✅    \\\cline{1-4}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md44}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md44}
\hypertarget{md_README_autotoc_md45}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md45}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md46}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md46}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md47}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md47}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md48}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md48}
\tabulinesep=1mm
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md49}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md49}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md50}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md50}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md51}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md51}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md52}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md52}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md53}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md53}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md54}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md54}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md55}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md55}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output.\hypertarget{md_README_autotoc_md56}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md56}
