...
async function setup(version = '') {
  ...
  if ((0,fs__WEBPACK_IMPORTED_MODULE_3__.existsSync)(binPath)) {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .addPath */ .fM)(binPath);
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Added to PATH: ${binPath}`);
  }
  (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .endGroup */ .N4)();
  ...
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('which', ['ifx']);
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('ifx', ['--version']);
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('which', ['icx']);
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('icx', ['--version']);
  (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .endGroup */ .N4)();
  ...
  const envVars = {
    ...
    LD_LIBRARY_PATH: [(0,path__WEBPACK_IMPORTED_MODULE_2__.join)(prefix, 'lib'), process__WEBPACK_IMPORTED_MODULE_5__.env.LD_LIBRARY_PATH || ''].filter(Boolean).join(':')
  };
