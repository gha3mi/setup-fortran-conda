...
/* harmony export */ });
/* harmony import */ var _flang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7628);
...
async function setup(version = '') {
  ...
  const packages = [
    (0,_common_js__WEBPACK_IMPORTED_MODULE_1__/* .createCondaPackageSpec */ .zk)('flang', version),
    (0,_common_js__WEBPACK_IMPORTED_MODULE_1__/* .createCondaPackageSpec */ .zk)('clangxx', version),
    'libflang-rt',
  ];
  ...
  const environment = (0,_common_js__WEBPACK_IMPORTED_MODULE_1__/* .createCompilerEnvironment */ .Tp)('flang', 'clang', 'clang++', {
  ...
  await (0,_common_js__WEBPACK_IMPORTED_MODULE_1__/* .exportCompilerEnvironment */ .x7)(environment);
