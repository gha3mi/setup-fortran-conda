...
async function setup(version = '') {
  ...
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('which', ['g++']);
  await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)('g++', ['--version']);
  (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .endGroup */ .N4)();
  ...
  const envVars = {
    ...
    LD_LIBRARY_PATH: [(0,path__WEBPACK_IMPORTED_MODULE_2__.join)(prefix, 'lib'), process.env.LD_LIBRARY_PATH || ''].filter(Boolean).join(':')
  };
