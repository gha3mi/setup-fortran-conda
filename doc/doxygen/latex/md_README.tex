...
\end{longtabu}
\hypertarget{md_README_autotoc_md19}{}\doxysubsection{\texorpdfstring{mac\+OS}{mac\+OS}}\label{md_README_autotoc_md19}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{longtabu}
\hypertarget{md_README_autotoc_md20}{}\doxysubsection{\texorpdfstring{Windows}{Windows}}\label{md_README_autotoc_md20}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fortran Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C Compiler   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ C++ Compiler    }\\\cline{1-3}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md21}{}\doxysection{\texorpdfstring{📋 Workflow Example}{📋 Workflow Example}}\label{md_README_autotoc_md21}
\hypertarget{md_README_autotoc_md22}{}\doxysubsection{\texorpdfstring{🔐 IMPORTANT NOTES}{🔐 IMPORTANT NOTES}}\label{md_README_autotoc_md22}
\begin{quote}
...
You can include only the jobs you need in your workflow. This example includes all available jobs to demonstrate a comprehensive CI/\+CD setup.\hypertarget{md_README_autotoc_md23}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{md_README_autotoc_md23}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md24}{}\doxysubsection{\texorpdfstring{README Integration}{README Integration}}\label{md_README_autotoc_md24}
...
\end{DoxyPre}
\hypertarget{md_README_autotoc_md25}{}\doxysubsection{\texorpdfstring{Job Breakdown}{Job Breakdown}}\label{md_README_autotoc_md25}
\tabulinesep=1mm
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md26}{}\doxysubsection{\texorpdfstring{Specifying Compiler Versions}{Specifying Compiler Versions}}\label{md_README_autotoc_md26}
...
\end{DoxyCode}
 If {\ttfamily compiler-\/version} is set to an empty string {\ttfamily "{}"{}}, the latest version will be installed.\hypertarget{md_README_autotoc_md27}{}\doxysubsection{\texorpdfstring{MPI Support}{MPI Support}}\label{md_README_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md28}{}\doxysection{\texorpdfstring{✅ Status}{✅ Status}}\label{md_README_autotoc_md28}
\tabulinesep=1mm
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md29}{}\doxysection{\texorpdfstring{🚀 Release Automation}{🚀 Release Automation}}\label{md_README_autotoc_md29}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md30}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_README_autotoc_md30}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md31}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{md_README_autotoc_md31}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md32}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md32}

\begin{DoxyCode}{0}
\DoxyCodeLine{bash\ release.sh\ -\/-\/help}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md33}{}\doxysubsection{\texorpdfstring{Recommended Workflow}{Recommended Workflow}}\label{md_README_autotoc_md33}
It’s highly recommended to first run in {\ttfamily -\/-\/dry-\/run} mode to verify the output, then in {\ttfamily -\/-\/local} mode to update files and tags locally, and finally without any flags to push changes and publish the Git\+Hub release.\hypertarget{md_README_autotoc_md34}{}\doxysection{\texorpdfstring{🔗 See Also}{🔗 See Also}}\label{md_README_autotoc_md34}
