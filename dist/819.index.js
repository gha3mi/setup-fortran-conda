...
/* harmony export */ });
/* harmony import */ var _flang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1616);
...
function clangRuntimeLibraryPaths(prefix) {
  const root = (0,node_path__WEBPACK_IMPORTED_MODULE_2__.join)(prefix, 'Library', 'lib', 'clang');
  if (!(0,node_fs__WEBPACK_IMPORTED_MODULE_1__.existsSync)(root)) return [];

  return (0,node_fs__WEBPACK_IMPORTED_MODULE_1__.readdirSync)(root, { withFileTypes: true })
    .filter((entry) => entry.isDirectory())
    .map((entry) => entry.name)
    .sort((a, b) => b.localeCompare(a, undefined, { numeric: true }))
    .map((version) =>
      (0,node_path__WEBPACK_IMPORTED_MODULE_2__.join)(root, version, 'lib', 'x86_64-pc-windows-msvc')
    )
    .filter((path) => (0,node_fs__WEBPACK_IMPORTED_MODULE_1__.existsSync)(path));
}
...
async function setup(version = '') {
  ...
  const prefix = await (0,_common_js__WEBPACK_IMPORTED_MODULE_3__/* .getCondaPrefix */ .s6)();
  const libraryPath = (0,node_path__WEBPACK_IMPORTED_MODULE_2__.join)(prefix, 'Library', 'lib');
  const runtimeLibraryPaths = clangRuntimeLibraryPaths(prefix);
  await (0,_common_js__WEBPACK_IMPORTED_MODULE_3__/* .addExistingPaths */ .Bf)([
    ...(0,_common_js__WEBPACK_IMPORTED_MODULE_3__/* .windowsCondaPaths */ .RB)(prefix),
    libraryPath,
    ...runtimeLibraryPaths,
  ]);
  ...
  await (0,_common_js__WEBPACK_IMPORTED_MODULE_3__/* .exportCompilerEnvironment */ .x7)(
    (0,_common_js__WEBPACK_IMPORTED_MODULE_3__/* .compilerEnvironment */ .HD)('flang', 'clang-cl', 'clang-cl', {
      INCLUDE: [(0,node_path__WEBPACK_IMPORTED_MODULE_2__.join)(prefix, 'Library', 'include'), process.env.INCLUDE || '']
        .filter(Boolean)
        .join(';'),
      LIB: [
        ...runtimeLibraryPaths,
